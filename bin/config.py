...
class EdgeGridConfig():
    ...
    def __init__(self, config_values, configuration, flags=None):
        ...
        parser.add_argument('--section', '-c', default='mediaservices', metavar='credentials_file_section', action='store', help=' Credentials file Section\'s name to use')
        ...
        list_domains_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')

        list_streams_parser = subparsers.add_parser("list-streams", help="List all Streams.")
        list_streams_parser.add_argument('domainName', help="Domain Name for which streams has to be fetched.", action='store')
        ...
        list_events_parser.add_argument('domainName', help="Domain Name for which streams has to be fetched.", action='store')
        list_events_parser.add_argument('streamId', help="Stream Id for which events has to be fetched.", action='store')
        list_events_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')

        list_rtmp_config_parser = subparsers.add_parser("list-rtmp-configs", help="List all RTMP Configs.")
        list_rtmp_config_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')

        list_rtmp_streams_parser = subparsers.add_parser("list-rtmp-streams", help="List all RTMP Streams.")
        list_rtmp_streams_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')

        list_storage_group_parser = subparsers.add_parser("list-storage-group", help="List all Storage Groups.")
        list_storage_group_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')

        get_domain_parser = subparsers.add_parser("get-domain", help="Get Domain.")
        get_domain_parser.add_argument('domain', help="Domain Name for which info has to be fetched.", action='store')
        get_domain_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')
        ...
        get_stream_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')
        ...
        get_event_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')

        get_rtmp_config_parser = subparsers.add_parser("get-rtmp-config", help="Get RTMP Config.")
        get_rtmp_config_parser.add_argument('cp-code', help="CP Code of the RTMP Config to be fetched.", action='store')
        get_rtmp_config_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')

        get_rtmp_stream_parser = subparsers.add_parser("get-rtmp-stream", help="Get RTMP Stream.")
        get_rtmp_stream_parser.add_argument('streamid', help="Stream id of the RTMP Stream", action='store')
        get_rtmp_stream_parser.add_argument('--output-type', '-t', default='text', choices=['json', 'text'],metavar='json/text', help=' Output type {json, text}. Default is text')
